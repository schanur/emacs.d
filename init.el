...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (darkane-theme zerodark-theme zenburn-theme yasnippet srefactor spacemacs-theme smex seti-theme ruby-refactor robe rainbow-delimiters neotree magit-svn magit-gitflow magit-find-file irony-eldoc hungry-delete hipster-theme hc-zenburn-theme flycheck-irony flycheck-bashate flx-ido f3 emr darkokai-theme cyberpunk-theme coverlay company-irony badger-theme avy-flycheck atom-one-dark-theme atom-dark-theme ample-theme))))
(custom-set-faces
